...
if __name__ == "__main__":
    collected_replies = []
    src_dir = 'data/collected_replies'
    date_str = sys.argv[1]
    ...
    all_replies = sorted(collected_replies)
    half1 = all_replies[:12]
    half2 = all_replies[12:]
    for replies_list in [half1, half2]:
        replies = []
        for filename in replies_list:
